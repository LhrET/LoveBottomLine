package net.app.lblpack.puch.frags.message;
...
import net.app.lblpack.common.tools.AudioPlayHelper;
import net.app.lblpack.common.widget.PortraitView;
import net.app.lblpack.common.widget.adapter.TextWatcherAdapter;
...
import net.app.lblpack.factory.presenter.message.ChatContract;
import net.app.lblpack.factory.utils.FileCache;
import net.app.lblpack.puch.R;
import net.app.lblpack.puch.activities.MessageActivity;
import net.app.lblpack.puch.frags.panel.PanelFragment;
